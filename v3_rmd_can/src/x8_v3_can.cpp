...
void process() //double Goal_Posi
{
  ...
  Present_Posi_03 = _can.Enco_Data_03 * DEG2RAD;

  if(t <= T) { //t <= T
    //Cmmd_Posi_01 = Present_Posi_01 + (Goal_Posi*DEG2RAD - Present_Posi_01)*0.5*(1.0-cos(PI*(t/T)));
    //Cmmd_Posi_01 = Present_Posi_01 + (Rmd_Goal_Posi[0] *DEG2RAD - Present_Posi_01)*0.5*(1.0-cos(PI*(t/T)));
    //Cmmd_Posi_02 = Present_Posi_02 + (Goal_Posi*DEG2RAD - Present_Posi_02)*0.5*(1.0-cos(PI*(t/T)));
    Cmmd_Posi_02 = Present_Posi_02 + (Rmd_Goal_Posi[1] *DEG2RAD - Present_Posi_02)*0.5*(1.0-cos(PI*(t/T)));
    //Cmmd_Posi_03 = Present_Posi_03 + (Goal_Posi*DEG2RAD - Present_Posi_03)*0.5*(1.0-cos(PI*(t/T)));
    Cmmd_Posi_03 = Present_Posi_03 + (Rmd_Goal_Posi[2] *DEG2RAD - Present_Posi_03)*0.5*(1.0-cos(PI*(t/T)));

    printf("t: [%lf]\n", t);
    //Now_pos_01 = _can.Read_RMD_Data_01();
    //Now_pos_02 = _can.Read_RMD_Data_02();  //_can.Read_RMD_Data();
    printf("01_Enco: [%lf]   ", Cmmd_Posi_01* RAD2DEG);
    printf("02_Enco: [%lf]   ", Cmmd_Posi_02* RAD2DEG);
    printf("03_Enco: [%lf]\n", Cmmd_Posi_03* RAD2DEG);
    //ROS_INFO("%lf\n", Now_pos_01);
    //ROS_INFO("%lf\n", Now_pos_02);
    ...
    //usleep(2000);
   // _can.Position_GoV3(0x143, Cmmd_Posi_03 * RAD2DEG);
   // usleep(2000);
